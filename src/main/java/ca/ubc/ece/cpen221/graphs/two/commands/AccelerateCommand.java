...
/**
 * An AccelerateCommand is a {@link Command} which represents a {@link Vehicle}
 * moving and accelerating. This Command moves that vehicle from one space to another and decreases
 * its cooldown.
 */
public final class AccelerateCommand implements Command {
    ...
    /**
     * Construct a {@link AccelerateCommand}, where <code>item</code> is the moving
     ...
     */
    public AccelerateCommand(Vehicle item, Location targetLocation) {
        this.item = item;
