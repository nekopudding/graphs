...
public final class Util {
     ...
     *
     * @param world  the current World
     * @param startW the starting x-coordinate (x-coordinate of the top-left corner
     *               of the bounding box)
     * @param startH the starting y-coordinate (y-coordinate of the top-left corner
     *               of the bounding box)
     ...
     *
     * @param world the current World
     * @param loc   the center location, all empty locations returned (if any) are
     *              adjacent to loc
    ...
    public static ImageIcon loadImage(String filename) {
        ...
        URL resource;
        try {
            resource = new File("images/" + filename).toURI().toURL();
        }
